...
namespace HTML5DecodePortable {
    public static class Utility {
        ...
        private static class HtmlEntities {
            ...
            private static readonly Dictionary<string, string> s_lookupTable =
                new Dictionary<string, string>(Count, StringComparer.Ordinal) {
                    ["Aacute"] = "\x00c1",
                    ["aacute"] = "\x00e1",
                    ["Abreve"] = "\x0102",
                    ["abreve"] = "\x0103",
    ...
    internal static class StringBuilderCache {
        ...
        public static StringBuilder Acquire(int capacity = 0) {
